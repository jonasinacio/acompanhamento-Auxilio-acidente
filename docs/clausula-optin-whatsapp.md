# Cláusula de opt-in de comunicação (WhatsApp / LGPD)
**Para inserir no contrato de honorários (ZapSign) — Jonas Inácio Advocacia**

> Modelo operacional. Revise com o responsável jurídico antes de adotar.

---

**CLÁUSULA — COMUNICAÇÃO, AUTORIZAÇÃO DE CONTATO E PROTEÇÃO DE DADOS**

**1.** O(A) CONTRATANTE **autoriza** o escritório a enviar comunicações sobre o andamento do seu processo pelos canais informados em seu cadastro, incluindo **WhatsApp, SMS, ligação telefônica e e-mail**.
...
**5.** O(A) CONTRATANTE pode **revogar a autorização** de contato por WhatsApp a qualquer tempo, mediante solicitação, sem prejuízo das comunicações essenciais ao andamento do processo.

**6.** É responsabilidade do(a) CONTRATANTE **manter seus dados de contato atualizados** junto ao escritório.
